    ...
    <div className="bg-purple py-14">
      ...
      >
        <div className="content text-center border w-[85%] ">
          ...
          <div className="w-full flex flex-col gap-8 md:flex-row md:gap-0 md:justify-between   ">
            <div className="flex flex-row  justify-between  border lg:gap-[145px] xlg:gap-[170px] xl:gap-[125px]  md:gap-[90px]">
