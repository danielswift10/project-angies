...
const Team = () => {
  return (
    <div>
      <div
        className={`${styles.boxWidth} ${styles.flexBetween} hidden ss:px-0 ss:w-[600px] lg:w-[1070px] xlg:w-[1150px] xl:w-[1280px] lg:px-0  md:w-[970px] md:px-0 ${styles.padding} gap-10 ${layout.section1}`}
      >
