      ...
      <div className="text-center px-5">
        ...
        >
          <Button
            ...
            classname={`${
              styles.image
            } ${"bg-pink shadow-yellowBtn font-pt text-white cursor-pointer py-[12px] w-full sm:w-[180px] md:w-[193px] rounded-[8px] lg:text-[24px]  md:text-[20px] text-[16px]  font-bold"} `}
          />
          <Button
            type={"button"}
            title={"View Courses"}
            classname={`${
              styles.image
            } ${"bg-yellow shadow-yellowBtn font-pt text-white cursor-pointer py-[12px] w-full md:w-[193px] sm:w-[180px] rounded-[8px] lg:text-[24px]  md:text-[20px] text-[16px]  font-bold"} `}
          />
        </div>
      </div>
      </div>
